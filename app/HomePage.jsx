	...
	return (
		<div className='py-4 min-h-screen bg-[#bababa]'>
			<div className='@container/home flex flex-col items-center max-w-screen-xl gap-4 mb-4 mx-auto md:gap-6 xl:gap-8'>
				...
				<div className='w-[95%] mx-auto grid grid-cols-3 place-items-center gap-y-9 @md/home:w-[85%] @lg/home:grid-cols-4 @3xl/home:w-[90%] @3xl/home:grid-cols-5 @3xl/home:gap-y-10 @5xl/home:w-[85%] @5xl/home:grid-cols-6 pt-6'>
					{teams.map((team, key) => {
