			...
			{roster.map((player, index) => {
				...
				return (
					<Link
						...
						className='flex items-center py-4 gap-4 sm:gap-5 md:gap-6 lg:gap-7 xl:gap-8'>
						<Image
						...
						/>
						<div className='flex justify-center items-center gap-2 sm:gap-3 sm:text-lg md:gap-4 md:text-xl lg:gap-5 lg:text-2xl xl:gap-6 xl:text-3xl'>
