...
export default function Linescore({
	...
	return (
		<div className='w-11/12 max-w-4xl mx-auto rounded-xl bg-slate-500 grid grid-cols-[20%_60%_20%] py-4'>
			...
			<div className='grid grid-rows-[20%_40%_40%] bg-slate-600 rounded-s-xl px-1'>
				<div className='row-start-1'>
					<div
						style={{ fontSize: textSize, lineHeight: textHeight }}
