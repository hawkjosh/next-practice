...
export default function ResultsBadge({ gameIdGm2, result, resultGm2, rescheduled }) {
  let color;
  result === "W"
    ? (color = "text-[green]")
    : result === "L"
  ...
  return (
    <>
      {rescheduled && (
        <div className="absolute bottom-[2%] text-[11px] font-bold text-rose-500 md:text-sm xl:text-base bg-[yellow] w-full text-center tracking-tighter">
          Rain Out
        </div>
      )}
