...
export default async function TeamDashboardPage({ params }) {
	...
	return (
		<div className='flex flex-col w-full gap-8'>
			...
			<div className='flex flex-col gap-6 w-11/12 mx-auto items-center justify-center lg:flex-row lg:items-start lg:gap-2'>
				<div className='flex flex-col w-max gap-4 px-4 mx-auto'>
					...
					<div>
						Runs Scored: <strong className='text-lg'>{runsScored}</strong> |
						Runs Allowed: <strong className='text-lg'>{runsAllowed}</strong>
					</div>
					<div>
						Run Differential:{' '}
