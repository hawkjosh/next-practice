...
export async function getTeam(id) {
	const url = buildUrl('teams', {}, { teamId: id, hydrate: 'deviceProperties' })
...
export async function getPlayer(id) {
	const url = buildUrl('player', { personId: id }, {hydrate: 'person'})
...
export async function getSchedule(id) {
	const url = buildUrl(
		'schedule',
		{},
		{ sportId: 1, season: 2023, gameType: 'R', teamId: id, hydrate: 'team' }
	)
